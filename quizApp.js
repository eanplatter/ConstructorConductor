...
var questionOne = new Question('T/F: Inheritance is achieved in JavaScript through Prototypes?',[],'T', 6);
var questionTwo = new Question('T/F: JavaScript is just a scripting version of Java',[],'F', 3);
var questionThree = new Question("T/F: In Javascript, == doesn't check 'type' but just the value - where === checks type and value",[],'T', 5);
